...
class JumpingTest(Node):
    def __init__(self,
        ...
        self.pub = self.create_publisher(JointsCommand,
                                        ...
                                        10)
        pakage_path = '/home/punk-opc/Desktop/softlegjump_ws/src/fatigue_test/' 
        print(pakage_path)
    ...
    def hold_zero_callback(self):
        ...
        if(self.counter < 5000):
            for j in range(len(self.jnt_names)):
                ...
                msg.kp_scale.append(0.0)
                msg.kd_scale.append(0.0)
...
def main(args=None):
    ...
    node = JumpingTest(node_name="diocaro", test_name='Test_jump_19_06_2024_019_q0_21',q_in=[-3.9,2.84])    
